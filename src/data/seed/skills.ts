...
export const SKILLS: SkillNode[] = [
  // ---- Quantitative ----------------------------------------------------
  {
    ...
    description:
      "Divisibility rules, remainder arithmetic, and combining remainder conditions.",
  ...
  },
  {
    ...
    description:
      "Computing percentages of a quantity and reversing a percentage change.",
    prerequisiteSkillId: null,
  },
  {
    id: "Q_PCT_A",
    ...
    description:
      "Successive percentage changes, votes/population style problems, multi-step percentage reasoning.",
  ...
  },
  {
    ...
    description:
      "Cost price, selling price, markup/discount composition, and combined profit-loss scenarios.",
  ...
  },
  {
    ...
    description:
      "Multi-party shares and age/proportion problems built on ratio reasoning.",
  ...
  // ---- Logical Reasoning -------------------------------------------------
  {
    ...
    description:
      "Identifying the rule governing a sequence and extrapolating it.",
    prerequisiteSkillId: null,
  },
  {
    id: "L_SEAT_L",
  ...
  },
  {
    ...
    description:
      "Placing people around a circular table; adds wraparound and 'opposite' reasoning on top of linear placement skills.",
  ...
  // ---- Verbal -------------------------------------------------------------
  {
    ...
    description:
      "Synonyms, antonyms, and choosing the word that fits a sentence's meaning.",
    prerequisiteSkillId: null,
  },
  {
    id: "V_RC",
    ...
    description:
      "Drawing supported conclusions from a short passage without over-reaching beyond what's stated.",
  ...
  },
  {
    ...
    description:
      "Spotting grammatical errors, including less-obvious subject-verb agreement rules.",
    prerequisiteSkillId: null,
  },
];
