...
export type DecisionContext =
  "TRAINING" | "PRACTICE" | "MOCK" | "FORMAL_ASSESSMENT";
...
export type EvidenceLevel =
  "OBSERVED" | "VERIFIED" | "SELF_REPORTED" | "INFERRED";
...
export type StrategyAssistanceLevel =
  "NONE" | "POST_ONLY" | "LIVE_LIMITED" | "FULL";
...
export type NewCalibrationSnapshot = Omit<
  CalibrationSnapshot,
  "id" | "computedAt"
>;
