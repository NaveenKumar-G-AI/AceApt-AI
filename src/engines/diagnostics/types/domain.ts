...
export type CapabilityStatus =
  "strong" | "solid" | "developing" | "needs_focus" | "insufficient_evidence";
export type DiagnosticConfidenceState =
  "high" | "moderate" | "low" | "conflicted" | "incomplete";
...
export type StoppingDecision =
  | {
      shouldStop: false;
      reason: "coverage_incomplete" | "confidence_insufficient";
    }
  | {
      shouldStop: true;
      reason:
        | "coverage_and_confidence_met"
