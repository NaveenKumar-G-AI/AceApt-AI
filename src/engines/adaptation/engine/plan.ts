...
function makeMixVerification(minutes: number, topics: string[]): CandidateAction {
  ...
  return {
    id: `mixed-verification::${topics.join("::")}`,
    topicId: "mixed",
    topicName: "Across aptitude skills",
    actionType: "MIX",
    bottleneck: "STABLE",
    severity: 0,
    ...
    priorityScore: 0,
    priorityBreakdown: [],
    rationale: ["Sample a mixture of aptitude questions after focused practice. This is another observation, not proof of improvement."]
  };
}
